...
Accumulator TraversableContainer<Data>::Fold(typename TraversableContainer<Data>::template FoldFun<Accumulator> func, Accumulator& base) const {
...
template <typename Data>
template <typename Accumulator>
Accumulator PreOrderTraversableContainer<Data>::PreOrderFold(typename PreOrderTraversableContainer<Data>::template FoldFun<Accumulator> func, Accumulator& base) const {
...
template <typename Data>
template <typename Accumulator>
Accumulator PostOrderTraversableContainer<Data>::PostOrderFold(typename PostOrderTraversableContainer<Data>::template FoldFun<Accumulator> func, Accumulator& base) const {
